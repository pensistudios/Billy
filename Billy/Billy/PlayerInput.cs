    ...
    class PlayerInput : Input
    {
        ...
        public new void Update(GameTime gt) 
        {
           ...
           // Debug.Write(drop);
            ...
            if (keyboard.IsKeyDown(Keys.Left) == true) { goLeft = true; }
                 else { goLeft = false; }
            if (keyboard.IsKeyDown(Keys.Right) == true) { goRight = true; }
                 else { goRight = false; }
            if (keyboard.IsKeyDown(Keys.Up) == true) { jump = true; }
                 else { jump = false; }
            if (keyboard.IsKeyDown(Keys.Down) == true) { drop = true; }
                 else { drop = false; }
